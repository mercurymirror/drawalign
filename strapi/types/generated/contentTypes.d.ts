...
export interface ApiCaseTagCaseTag extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Tags Cas clients';
    pluralName: 'case-tags';
    singularName: 'case-tag';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    client_cases: Schema.Attribute.Relation<
      'manyToMany',
      'api::client-case.client-case'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiClientCaseClientCase extends Struct.CollectionTypeSchema {
  collectionName: 'client_cases';
  info: {
    displayName: 'Cas clients';
    pluralName: 'client-cases';
    singularName: 'client-case';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expertises: Schema.Attribute.Relation<
      'manyToMany',
    ...
    results_metrics: Schema.Attribute.Component<'elements.metric-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiExpertiseExpertise extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    client_case_header: Schema.Attribute.Component<
    ...
    fullWidthImage2: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    square_logo_icon: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    convictions: Schema.Attribute.Component<'home.convictions-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    logos: Schema.Attribute.Component<'home.logos-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    quoteSection: Schema.Attribute.Component<'home.quote-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMethodeHldbMethodeHldb extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'M\u00E9thode HLDB';
    pluralName: 'methode-hldbs';
    singularName: 'methode-hldb';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    diagram_right: Schema.Attribute.Component<'methode.diagram-card', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    maturity_image: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    maturity_text: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    maturity_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    principles_items: Schema.Attribute.Component<'home.conviction-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    principles_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    section3_cta: Schema.Attribute.Component<'elements.cta-link', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    theoretical_items: Schema.Attribute.Component<
      'home.conviction-item',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    theoretical_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPartenairePartenaire extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    partenaireTitle: Schema.Attribute.Component<
      'shared.section-header',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
