...
export function TeamMemberCard({
  ...
  return (
    <div className="grid grid-cols-1 overflow-hidden rounded-2xl bg-accent-peach p-20 md:grid-cols-[280px_1fr]">
      {image && (
      ...
      <div className="flex flex-col gap-6 p-8 lg:p-10">
        <div>
          <h3 className="text-[32px] tracking-tight">{name}</h3>
          {role && <p className="text-primary text-sm lg:text-2xl">{role}</p>}
        </div>
